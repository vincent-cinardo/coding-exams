<?php
  ...
  if($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if(!empty($question) && !empty($answer) && !empty($difficulty) && !empty($testcases)) {
      ...
      curl_setopt($curl, CURLOPT_POSTFIELDS, array("question" => $question, "answer" => $answer, "difficulty" => $difficulty, "testcases" => $testcases));
